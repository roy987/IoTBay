...
<head>
    ...
    <style>
        ...
        .header {
            padding:20px;
            background-color: <%= favColour %>; /* Set header background color based on user's favorite color */
            border-radius: 10px; 
            display:flex;
            text-align:center;
        ...
        .infoItems {           
            text-align:center;
            align-items:center;  
            background-color: <%= favColour %>; /* Set section background color based on user's favorite color */
            margin-left:30%;
            margin-right:30%;
            border-radius:20px;
            padding:20px;
